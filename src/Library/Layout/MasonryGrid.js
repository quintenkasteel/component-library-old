...
const InnerMasonryGrid = styled.div`
  ...
  ${breakpoint.smMd`
    -moz-grid-template-columns: repeat(${props => props.tabletColumns}, 1fr);
      -webkit-grid-template-columns: repeat(${props =>
        props.tabletColumns}, 1fr);
      grid-template-columns: repeat(${props => props.tabletColumns}, 1fr);
  ...
  ${breakpoint.mdLg`
      -moz-grid-template-columns: repeat(${props => props.desktopColumns}, 1fr);
      -webkit-grid-template-columns: repeat(${props =>
        props.desktopColumns}, 1fr);
...
const MasonryGridItem = styled.div`
  ...
  &:first-child {
    ...
    ${breakpoint.smMd`
      grid-column: 1 / span ${props => props.tabletColumns};
      grid-row: 1 / 1;
      `}

    ${breakpoint.mdLg`
      grid-column: 1 / span ${props => Math.round(props.desktopColumns / 2)};
      grid-row: 1 / 1;
      `}
  }
